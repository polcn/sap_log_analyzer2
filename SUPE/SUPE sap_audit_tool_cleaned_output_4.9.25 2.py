...
def identify_unmatched_records(valid_correlated, sm20, cdpos_merged):
    """Identify records that couldn't be correlated and drop irrelevant columns."""
    ...
    try:
        ...
        unmatched_cdpos = cdpos_merged[
            ...
            'original_cdpos_index', 'text flag', 'has_aging_filter'
        ], errors='ignore')
        ...
        unmatched_sm20 = sm20[
            ...
            'original_sm20_index', 'is_display_only', 'display_but_changed',
            'has_sysaid', 'has_comment'
        ], errors='ignore')
