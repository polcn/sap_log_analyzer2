...
def generate_excel_output(correlated_df, unmatched_cdpos, unmatched_sm20, output_file):
    # Trim output columns
    correlated_df = correlated_df[[col for col in correlated_df.columns if col in ['user', 'Change_Timestamp', 'SM20_Datetime', 'Table_Name', 'field name', 'Change_Indicator', 'new value', 'old value', 'TCode_CD', 'source ta', 'audit log msg. text', 'Risk Level', 'Risk Rationale', 'doc.number', 'object', 'object value']]]
    unmatched_cdpos = unmatched_cdpos[[col for col in unmatched_cdpos.columns if col in ['user', 'Change_Timestamp', 'Table_Name', 'field name', 'Change_Indicator', 'new value', 'old value', 'doc.number', 'object', 'object value']]]
    unmatched_sm20 = unmatched_sm20[[col for col in unmatched_sm20.columns if col in ['user', 'SM20_Datetime', 'source ta', 'audit log msg. text', 'Risk Level', 'Risk Rationale']]]
