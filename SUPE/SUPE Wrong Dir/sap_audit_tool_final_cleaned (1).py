...
def main():
    ...
    try:
        ...
        try:
            ...
            unmatched_sm20["Risk Level"] = "Unknown"
            unmatched_sm20["Risk Rationale"] = "Risk assessment failed"
        ...
        try:
            ...
            # Create empty risk columns to avoid errors later
            correlated_df["Risk Level"] = "Unknown"
            correlated_df["Risk Rationale"] = "Risk assessment failed"
